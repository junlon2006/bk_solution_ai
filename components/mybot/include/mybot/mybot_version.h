...
/*
 * Generated from mybot_version.h.in by CMake (configure_file). The version is
 * defined once in CMakeLists.txt; do not edit this file directly.
 */
#define MYBOT_VERSION_MAJOR 1
#define MYBOT_VERSION_MINOR 2
#define MYBOT_VERSION_PATCH 0
#define MYBOT_VERSION_PRERELEASE ""
#define MYBOT_VERSION_STRING "1.2.0"
